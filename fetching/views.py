...
def moderate_oclocher_organization(request, category, status, moderation_uuid=None):
    return get_moderate_response(request, category, 'oclocher_organization', status,
...
@login_required
@permission_required("scheduling.change_sentence")
def moderate_oclocher_matching(request, category, status, moderation_uuid=None):
    return get_moderate_response(request, category, 'oclocher_matching', status,

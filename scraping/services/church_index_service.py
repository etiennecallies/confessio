...
def event_from_church_index_event(church_index_event: ChurchIndexEvent) -> Event | None:
    if church_index_event.day is None or church_index_event.start_time is None:
        return None

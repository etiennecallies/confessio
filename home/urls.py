...
urlpatterns = [
    ...
    path('moderate-church/<category>', views.moderate_parish, name='moderate_next_church'),
    path('moderate-church/<category>/<uuid:moderation_uuid>', views.moderate_parish,
         name='moderate_one_church'),
    path('moderate-scraping/<category>', views.moderate_parish, name='moderate_next_scraping'),
    path('moderate-scraping/<category>/<uuid:moderation_uuid>', views.moderate_parish,

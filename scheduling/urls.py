...
urlpatterns = [
    ...
    # moderations
    path('moderate/pruning/<category>/<str:status>',
         views.moderate_pruning, name='moderate_next_pruning'),
    path('moderate/pruning/<category>/<str:status>/<uuid:moderation_uuid>',
         views.moderate_pruning, name='moderate_one_pruning'),
    path('moderate/sentence/<category>/<str:status>',
         views.moderate_sentence, name='moderate_next_sentence'),
    path('moderate/sentence/<category>/<str:status>/<uuid:moderation_uuid>',
         views.moderate_sentence, name='moderate_one_sentence'),
    path('moderate/parsing/<category>/<str:status>',
         views.moderate_parsing, name='moderate_next_parsing'),
    path('moderate/parsing/<category>/<str:status>/<uuid:moderation_uuid>',
         views.moderate_parsing, name='moderate_one_parsing'),
    path('moderate/scheduling/<category>/<str:status>',
         views.moderate_scheduling, name='moderate_next_scheduling'),
    path('moderate/scheduling/<category>/<str:status>/<uuid:moderation_uuid>',
         views.moderate_scheduling, name='moderate_one_scheduling'),
    path('moderate/validated_schedules/<category>/<str:status>',
         views.moderate_validated_schedules, name='moderate_next_validated_schedules'),
    path('moderate/validated_schedules/<category>/<str:status>/<uuid:moderation_uuid>',

...
def moderate_pruning(request, category, status, moderation_uuid=None):
    return get_moderate_response(request, category, 'pruning', status,
...
@login_required
@permission_required("scheduling.change_sentence")
def moderate_sentence(request, category, status, moderation_uuid=None):
    return get_moderate_response(request, category, 'sentence', status,
...
@login_required
@permission_required("scheduling.change_sentence")
def moderate_parsing(request, category, status, moderation_uuid=None):
    return get_moderate_response(request, category, 'parsing', status,
...
@login_required
@permission_required("scheduling.change_sentence")
def moderate_scheduling(request, category, status, moderation_uuid=None):
    return get_moderate_response(request, category, 'scheduling', status,
...
@login_required
@permission_required("scheduling.change_sentence")
def moderate_validated_schedules(request, category, status, moderation_uuid=None):
    return get_moderate_response(request, category, 'validated_schedules', status,
